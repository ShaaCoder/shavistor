...
<RadioGroup value={paymentMethod} onValueChange={value => setPaymentMethod(value as 'card' | 'upi' | 'cod' | 'razorpay')} className="space-y-4">
                      ...
                      <div className="flex items-center space-x-4 p-4 rounded-2xl border-2 border-gray-200 hover:border-blue-300 transition-colors">
                        ...
                        <Label htmlFor="upi" className="flex items-center gap-3 font-medium cursor-pointer flex-1">
                          ...
                          <span>UPI Payment (Stripe)</span>
                          <Badge variant="outline" className="ml-auto">Instant</Badge>
                        </Label>
                      </div>
                      <div className="flex items-center space-x-4 p-4 rounded-2xl border-2 border-gray-200 hover:border-blue-300 transition-colors">
                        <RadioGroupItem value="razorpay" id="razorpay" className="text-blue-600" />
                        <Label htmlFor="razorpay" className="flex items-center gap-3 font-medium cursor-pointer flex-1">
                          <Zap className="w-5 h-5 text-gray-600" />
